<?php 
    ...
    if(isset($_GET['c_id'])){
        ...
        $sql = "SELECT name, account_num, current_balance FROM cadenceuser WHERE customer_id='$customer_id'";
    ...
    if(isset($_POST["name"]) && isset($_POST["account_num"]) && isset($_POST["c_account_num"]) && isset($_POST["amount"])){
        ...
        //if recipient's account number doesn't exist
            ...
            $sql = "SELECT * FROM cadenceuser WHERE name='$name' AND account_num='$recipient_account_num'";
            $result = $conn->query($sql);
            $row = $result->fetch_assoc();
        ...
        if($control){
            ...
            $sql = "UPDATE `cadenceuser` SET current_balance='$new_sender_bal' WHERE account_num='$sender_acc_num'";
            $conn->query($sql);

            $new_sender_bal = $sender_balance-$amount;
            $sql = "UPDATE `cadenceuser` SET current_balance='$new_recipient_bal' WHERE account_num='$recipient_account_num'";
            $conn->query($sql);
